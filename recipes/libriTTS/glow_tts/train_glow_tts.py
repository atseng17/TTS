...
# dataset_path = "/mnt/aibb_data/development/atseng/VCproject/LibriTTS/train-clean-100"
# meta_file_train_path = "dev-clean"
...
# dataset_config = BaseDatasetConfig(name="libri_tts", meta_file_train=meta_file_train_path, path=dataset_path)
...
# print('config.audio,config.audio,config.audio,config.audio',config.audio.sample_rate)
# sdfsdf
